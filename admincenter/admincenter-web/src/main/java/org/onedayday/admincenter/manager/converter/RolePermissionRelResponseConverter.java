...
/**   
 * @Title: RolePermissionRelResponseConverter
 * @Description:
 * @author generator
...
public interface RolePermissionRelResponseConverter  extends BaseConverter<RolePermissionRelResponse,RolePermissionRelDTO >{
