...
/**   
 * @Title: RolePermissionRelRequestConverter
 * @Description:
 * @author generator
...
public interface RolePermissionRelRequestConverter  extends BaseConverter<RolePermissionRelRequest,RolePermissionRelDTO >{
